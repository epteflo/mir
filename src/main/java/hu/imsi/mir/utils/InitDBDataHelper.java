                ...
                for (int i = 1; i < 1000; i++) {
                    ...
                    if (s != null) {
                        ...
                        switch(k) {
                            ...
                            case CONTENT_OBJECT : obj = dbHelper.createContentObject(args[0], args[1], (HContent) objectHash.get(args[2]), (HMuseum) objectHash.get(args[3]),(HRoom) objectHash.get(args[4]), (HPoi) objectHash.get(args[5]), (HExhibition) objectHash.get(args[6]), (HExhibitionTour) objectHash.get(args[7]), args[8]); break;
                            default : break;
                        }
