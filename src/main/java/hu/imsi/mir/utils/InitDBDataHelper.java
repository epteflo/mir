                ...
                for (int i = 1; i < 1000; i++) {
                    ...
                    if (s != null) {
                        ...
                        switch(k) {
                            ...
                            case CONTENT_OBJECT : obj = dbHelper.createContentObject((HContent) objectHash.get(args[0]), (HMuseum) objectHash.get(args[1]),(HRoom) objectHash.get(args[2]), (HPoi) objectHash.get(args[3]),args[4]); break;
                            default : break;
                        }
